...
namespace Ddd
{
	...
	public interface IUniqueService
	{
		...
		Task<Guid> GetOrAddUniqueValueKey(string valueGroup, string value, Guid requestedKey, bool ignoreCase = true);
		...
		Task<Tuple<bool, Guid>> TryGetUniqueValueKey(string valueGroup, string value, bool ignoreCase = true);
		...
		Task<bool> TryRemoveUniqueValueKey(string valueGroup, string value, Guid key, bool ignoreCase = true);
	}
}
